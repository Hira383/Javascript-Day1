...
var username = "John"; //here = is an assignment operator
console.log(username);
//Arithmetic operators are used to perform simple calculations
var add = 2 + 3; //here we can used arithmetic (+) operator to add two values
console.log(add);
...
console.log(a<b);
console.log(a>b);
//Logical Operators are used in JS to determine whether the value is true or false
//(&&)and operator is used when two both values are true 2>1 && 4<5 true if one of the value is false it will return false
console.log(a==b && b==c);
//(||)or operator is used when one of the value is true 3>1 || 3<2 true if both false it will return false
console.log(a==b||b==c);
//(!)not operator to not value true to false and false to true
console.log(!a==b);
